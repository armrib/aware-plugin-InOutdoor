...
public class Provider extends ContentProvider {
    ...
    public static String AUTHORITY = "com.aware.plugin.inoutdoor.provider.inoutdoor";

    private static final int IO_METER = 1;
    private static final int IO_METER_ID = 2;

    public static final String DATABASE_NAME = Environment.getExternalStorageDirectory() + "/AWARE/plugin_inoutdoor.db";
    ...
    public static final String[] TABLES_FIELDS = {
            IOMeter_Data._ID + " integer primary key autoincrement," +
                    ...
                    IOMeter_Data.IO_STATUS + " text default ''," +
    ...
    public static final class IOMeter_Data implements BaseColumns {
        ...
        public static final Uri CONTENT_URI = Uri.parse("content://"+AUTHORITY+"/plugin_inoutdoor");
        public static final String CONTENT_TYPE = "vnd.android.cursor.dir/vnd.aware.plugin.inoutdoor";
        public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/vnd.aware.plugin.inoutdoor";
    ...
    public boolean onCreate() {
        ...
        AUTHORITY = getContext().getPackageName() + ".provider.inoutdoor";
